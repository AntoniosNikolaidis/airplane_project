...
and I use inheritance in my classes. At the end I clone an object and I see if objects 
are identical equal or just equal then I use my update function and make some print for 
the length of the string and the middle characters 
For the complication I create a makefile.
So with the command make we can compile it and with ./Air we can run it
